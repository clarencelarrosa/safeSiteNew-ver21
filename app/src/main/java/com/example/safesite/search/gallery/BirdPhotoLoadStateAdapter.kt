...
import com.example.safesite.databinding.ImageLoadStateFooterBinding


class BirdPhotoLoadStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<BirdPhotoLoadStateAdapter.LoadStateViewHolder>() {
